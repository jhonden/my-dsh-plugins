/* Generated by scripts/gen-typert.mjs — do not edit by hand.
        ...
        'types': [
          {
            ...
            'declaration': "export interface NotifyGetStateRequest {\n}",
          },
          {
            'name': 'NotifyMode',
          ...
          },
          {
            ...
            'declaration': "export interface NotifyPreviewResult {\n    ok: boolean;\n}",
          },
          {
            'name': 'NotifySetArmedRequest',
            'declaration': "export interface NotifySetArmedRequest {\n    armed: boolean;\n}",
          },
          {
            'name': 'NotifySetArmedResult',
            'declaration': "export interface NotifySetArmedResult {\n    armed: boolean;\n}",
          },
          {
            'name': 'NotifyPrefs',
            'declaration': "export interface NotifyPrefs {\n    sound: string;\n    volume?: number;\n    mode: NotifyMode;\n}",
          },
          {
            'name': 'NotifySetPrefsRequest',
            'declaration': "export interface NotifySetPrefsRequest {\n    sound?: string;\n    volume?: number;\n    mode?: NotifyMode;\n}",
          },
          {
            'name': 'NotifySoundListResult',
            'declaration': "export interface NotifySoundListResult {\n    names: string[];\n}",
          },
          {
            'name': 'NotifyState',
            'declaration': "export interface NotifyState {\n    armed: boolean;\n}",
          },
        ],
      },
    ],
