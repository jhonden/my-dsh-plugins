...
export type FilesErrorCode = 'FILES_PATH_OUTSIDE_WORKSPACE' | 'FILES_NOT_FOUND' | 'FILES_NOT_A_DIRECTORY' | 'FILES_NOT_A_REGULAR_FILE' | 'FILES_SYMLINK_REJECTED' | 'FILES_TOO_LARGE' | 'FILES_BINARY_REJECTED' | 'FILES_SESSION_WITHOUT_CWD';
